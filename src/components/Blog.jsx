export default function Blog() {
  return (
    <section
      id="Blog"
      className="bg-green-200 py-10 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 text-center"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-700 max-w-xl mx-auto mb-6 sm:mb-8">
